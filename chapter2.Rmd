...
With this test we get a p-value of `r round(whiteresults$p.value, digits=3)`, which is the same result than with the earlier test. We have found no evidence against the assumptions of our linear regression.
